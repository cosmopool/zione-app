...
mixin _$TicketStore on _TicketStore, Store {
  final _$loadingAtom = Atom(name: '_TicketStore.loading');
  ...
  final _$failureAtom = Atom(name: '_TicketStore.failure');
  ...
  final _$ticketsAtom = Atom(name: '_TicketStore.tickets');
  ...
  final _$fetchTicketsAsyncAction = AsyncAction('_TicketStore.fetchTickets');
